...
class MyCalibrator(trt.IInt8EntropyCalibrator2):
    def __init__(self, calibration_data_path, n_calibration, input_shape, cache_file):
        ...
        # for per_class in os.listdir(calibration_data_path):
        #     per_class_path = os.path.join(calibration_data_path, per_class)
...
if __name__ == "__main__":
    ...
    m = MyCalibrator("../../../../flower_classify_dataset/val/", 5, (1, 3, 224, 224), "./int8.cache")
